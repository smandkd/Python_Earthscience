...
ax = fig.add_subplot(1,1,1, projection=crs.Robinson())# 지도의 범위를 설정한다. 
typhoon_name = 'MAEMI' # 태풍 이름
text = AnchoredText(r'NAME: {}'.format(typhoon_name), loc=4, prop={'size': 12}, frameon=True) # 지도 우측 하단에 태풍 이름 추가 
ax.add_artist(text)
