...
ds = run_sample_dataset('/home/tkdals/homework_3/MPI_ex/tcpyPI-1.3/data/sample_data.nc')
# ds = run_sample_dataset('./MPI_ex/tcpyPI-1.3/data/sample_data.nc')
ds.to_netcdf('0306_sample_output.nc')
print('...PI computation complete and saved\n')

# %%
dataset = xr.open_dataset('0306_sample_output.nc')
dataset
